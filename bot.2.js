 ...
 **
رابط البوت | https://discordapp.com/api/oauth2/authorize?client_id=555473002188242959&permissions=8&scope=bot
 **
`);
  message.author.sendEmbed(embed);
   }
 ...
 **
رابط السيرفر | https://discord.gg/VarGmc
 **
`);
  message.author.sendEmbed(embed);
   }
...
client.login('NTU1NDczMDAyMTg4MjQyOTU5.D2rsbg.eRwAmUMR75Pb8clFwDkmPIiDsjw');